...
Pod::Spec.new do |s|
  ...
  s.version          = '1.7'
  s.summary          = 'EventKit helper for Swift 4'
  s.description      = <<-DESC
EventKit helper for Swift 4 to create, delete and update events in the easiest way!
                       DESC

  s.homepage         = 'https://github.com/AlbertMontserrat/AMGCalendarManager'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Albert' => 'albert.montserrat.gambus@gmail.com' }
  s.source           = { :git => 'https://github.com/mittenimraum/AMGCalendarManager.git', :tag => s.version.to_s }
